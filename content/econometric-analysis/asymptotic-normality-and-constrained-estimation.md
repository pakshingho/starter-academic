...
This chapter will later connect asymptotic normality, constrained estimation, and numerical optimization so the different estimators can be compared in a common framework.
...
- 7.2.3 Consistency of restricted least squares for A0
