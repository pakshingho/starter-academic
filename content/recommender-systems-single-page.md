...
Use the [handbook version](/recommender-systems/) if you want chapter navigation and the left sidebar.

## Chapter Guide

1. [Why Recommender Systems Matter](/recommender-systems/why-it-matters/)
2. [Explicit vs. Implicit Feedback](/recommender-systems/explicit-vs-implicit-feedback/)
3. [Model Families](/recommender-systems/model-families/)
4. [Matrix Factorization](/recommender-systems/matrix-factorization/)
5. [Feature-Rich Recommendation](/recommender-systems/feature-rich-recommendation/)
6. [Deep Models](/recommender-systems/deep-models/)
7. [Production Concerns](/recommender-systems/production-concerns/)
8. [Build Sequence](/recommender-systems/build-sequence/)
9. [Summary](/recommender-systems/summary/)
10. [References](/recommender-systems/references/)
11. [Survey Papers and Further Reading](/recommender-systems/survey-papers-and-further-reading/)
...
<div id="core-modeling-papers"></div>

### 10.2 Core modeling papers

- [Mnih and Salakhutdinov (2007): Probabilistic Matrix Factorization](https://papers.nips.cc/paper_files/paper/2007/hash/d7322ed717dedf1eb4e6e52a37ea7bcd-Abstract.html)
...
<div id="tools-and-implementations"></div>
...
<div id="how-to-use-survey-papers-efficiently"></div>
